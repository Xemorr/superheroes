...
public enum Power {
    ...
    Superhuman("&c&lSuperhuman", "You are a more powerful human"), Mole("&6&lThe Mole", "You can instant break certain blocks"),
    ...
    Strongman("&c&lStrongman", "You can pick up mobs and throw them."),Speedster("&b&lSpeedster", "You have Speed IV, 'gotta go fast'"),Gun("&8&lGun", "You have a gun."),
    ...
    Doomfist("&8&lDoomfist", "You are doomfist."), Slime("&a&lSlime", "You can bounce along the floor!"), Zeus("&e&lZeus", "Punching causes you to strike lightning wherever you look.");
