...
public class PotionEffectData {
    ...
    public PotionEffectData(ConfigurationSection configurationSection, @NotNull PotionEffectType defaultType, int defaultDuration, int defaultPotency) {
        ...
        if (potionType == null) {
            ...
            Superheroes.getInstance().getLogger().warning("You have entered an invalid potion effect type! " + configurationSection.getCurrentPath() + ".type" + " . Defaulting to " + defaultType.getName());
        }
