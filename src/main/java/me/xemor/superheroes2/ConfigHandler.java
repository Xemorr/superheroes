...
public class ConfigHandler {
    ...
    private final static String[] resources = new String[]{"strongman", "doomfist", "phase", "pickpocket", "superhuman", "mole", "robot", "slime", "aerosurfer", "trap", "chicken", "frozone", "lavawalker"};
